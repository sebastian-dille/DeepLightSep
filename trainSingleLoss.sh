#!/bin/bash
#SBATCH -J SINGLELOSS     # Name that will show up in squeue
...
echo $CUDA_AVAILABLE_DEVICES
 python train.py --dataroot /project/aksoy-lab/datasets/MultiIllumWild/ --model threelayers_color --continue_train --name SingleColorLoss --batch_size 8 --lrA 0.0001 --lrB 0.0001 --niter 100 --niter_decay 100  --display_id -1 --gpu_ids 0,1,2,3
